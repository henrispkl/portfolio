...
const projects = {
  ...
  medicare: {
    ...
    name: 'Medicare',
    overview:
      'A fictional freelancing platform for healthcare workers. It uses the MERN stack and has a simple CRUD for jobs and professionals. It also has a simple JWT authentication for user login/registration.',
  ...
  mernBB: {
    ...
    name: 'MernBB',
    overview:
      'Built with the MERN stack, this is a bulletin board where users can authenticate and post topics and reply to them in different categories divided by subcategories. The user can authenticate with JWT to start consuming an API with CRUDs and other operations for categories, subcategories, users, user groups, topics and posts.',
